...
class OrderService:
    ...
    def _map_db_order_to_domain(self, db_order, with_products=False):
        return Order(
            id=db_order.id,
...
#   General orders
    ...
    def get_all(self):
        ...
        return [
            self._map_db_order_to_domain(o, with_products=False) for o in db_orders
        ]
...
#   Specific orders
    ...
    def get_by_id(self, order_id: int):
        ...
        if not db_order:
            return None
        return self._map_db_order_to_domain(db_order, with_products=False)
    ...
    def get_by_id_with_products(self, order_id: int):
        ...
        if not db_order:
            return None
        return self._map_db_order_to_domain(db_order, with_products=True)
    ...
    def get_all_by_table_id_open_orders_with_products(self, table_id: int):
        db_orders = self.repository.get_by_all_table_id_open_orders_with_products(table_id)
        return [
            self._map_db_order_to_domain(o, with_products=True) for o in db_orders
        ]
    ...
    def add_product_to_order(self, order: Order, product:Product_Order):
    ...
    def add_unit_product_to_order(self, order: Order, product_id:int):
    ...
    def subst_unit_product_to_order(self, order: Order, product_id:int):
    ...
    def update_product_quantity_in_order(self, order: Order, product_id:int, quantity:int):
    ...
    def delete_product_to_order(self, order: Order, product_id:int):
    ...
    def update(self, order: Order):
        ...
        order.total_amount = OrderService.calculate_total_amount(order)
